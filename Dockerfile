...
RUN install_packages wget make git
...
RUN git clone -c http.sslVerify=false https://c2d44921eeb69d65f8eb297e721f463039d0453d:x-oauth-basic@github.com/jeremyhahn/tradebot.git "${GOPATH}/src/github.com/jeremyhahn/tradebot"
